...
unsigned short int get_adresse_definie_source(unsigned short int mot,  processeur *p);

/*unsigned short int get_adresse(unsigned short int mot, ecriture *e processeur *p, adresse *ad);*/ /*fonction récupérant l'adresse désignée par le mot passé en paramètre*/
...
unsigned short int get_adresse_definie_dest(unsigned short int mot,  processeur *p);
#endif

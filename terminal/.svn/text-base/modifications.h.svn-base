...
void  creer_liste(processeur liste_processeur[][16], int argc, char **argv, adresse ad1, adresse ad2, short c1, short c2);
void controle_victoire(processeur liste_processeur[][16],short c1, short c2);

...
class CInstruction
{
      Q_DECLARE_TR_FUNCTIONS(CInstruction);
   public:
...
class CZeroOperandInstruction : public CInstruction
{
   public:
...
class COneOperandInstruction : public CInstruction
{
   public:
      virtual bool checkOperands(QStringList &operands);
...
class CTwoOperandInstruction : public CInstruction
{
   public:
      virtual bool checkOperands(QStringList &operands);
...
{
   public:
      static CInstruction *create(const QString &name);
};
